...
class PreloaderModule {
    constructor() {
        ...
        this.quotes = [
            ...
            // Russian
            "Мода — это доспехи, чтобы выжить в реальности повседневной жизни.",
            "Стиль — это способ сказать, кто ты, не произнося ни слова.",
            "Элегантность — это единственная красота, которая никогда не увядает.",
            "Красота начинается в тот момент, когда вы решаете быть собой.",
            // Uzbek
            "Moda — bu kundalik hayot haqiqatida omon qolish uchun zirh.",
            "Uslub — bu kimligingizni so‘zsiz ifodalash usuli.",
            "Nafislik — hech qachon so‘nmaydigan go‘zallik.",
            "Go‘zallik, siz o‘zingiz bo‘lishga qaror qilgan ondan boshlanadi."
        ];
